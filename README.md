...
|    |  [신민용](https://github.com/minyong-shin)    |    |[\[데이터셋\] 롤토체스(TFT) 골드 ~ 챌린저(Low elo ~ High elo) 매치 데이터셋](https://github.com/minyong-shin/labs/blob/master/1_creating_dataset/Kaggle%20Dataset(Riot%20DB)%20-%20TFT%20Match%20Data(High%20elo).ipynb) <br/> [\[데이터셋\] 롤토체스(TFT) 아이템, 챔피언 데이터셋](https://github.com/minyong-shin/labs/blob/master/1_creating_dataset/Kaggle%20Dataset(Riot%20DB)%20-%20TFT%20Champion%20information.ipynb) <br/> [\[데이터셋\] 리그오브레전드(LOL) 경기 시작 후 10분, 15분까지의 매치 데이터셋](https://github.com/minyong-shin/labs/blob/master/1_creating_dataset/Kaggle%20Dataset(Riot%20DB)%20-%20Riot%20timeline%20dataset.ipynb) <br/> [\[데이터셋\] 리그오브레전드(LOL) 상위 티어(High elo) 매치 데이터셋](https://github.com/minyong-shin/labs/blob/master/1_creating_dataset/Kaggle%20Dataset(Riot%20DB)%20-%20Remind%20RiotAPI%20using.ipynb) <br/> [\[데이터셋\] 리그오브레전드(LOL) 아이템, 챔피언 데이터셋](https://github.com/minyong-shin/labs/blob/master/1_creating_dataset/Kaggle%20Dataset(Riot%20DB)%20-%20each%20tier%2C%20match%20summary.ipynb) <br/> [\[데이터셋\] 서울시 지하철 승하차(일별, 월별, 시간별) 데이터셋](https://github.com/minyong-shin/labs/blob/master/1_creating_dataset/Kaggle%20Dataset%20-%20Subway%20daily%2C%20monthly%20boarding.ipynb) <br/> [\[데이터셋\]  최종 구축한 데이터셋 목록](https://www.kaggle.com/gyejr95/datasets) |   |
